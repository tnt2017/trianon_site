	...
	<div class="container-fluid">
		...
		<div id="navbar" class="navbar-collapse collapse">
			<ul class="nav navbar-nav navbar-right ">
				...
				<li>
					<a href="http://10.8.0.95/" rel="tooltip" target='_blank' title='Рэдмайн' data-placement="bottom">
						<i class='glyphicon glyphicon-tasks'></i>
						<span class='visible-xs-inline'>Рэдмайн</span>
					</a>
				</li>
				<li>
					<a href="#" title='Настройки' rel="tooltip" data-placement="bottom"> 
						<i class='glyphicon glyphicon-cog'></i>
						<span class='visible-xs-inline'>Настройки</span>
					</a>
				</li>
				<li>
					<a href="#" title='Помощь и инструкции' rel="tooltip" data-placement="bottom">
						<i class='showFaqtoid glyphicon glyphicon-exclamation-sign'></i>
						<span class='visible-xs-inline'>Помощь и инструкции</span>
					</a>
				</li>
				<li class='dropdown '>
