...
<link rel=stylesheet type="text/css" href="js/jquery.simple-dtpicker.css" />
<!-- 10.05.2016 -->
...
<script type="text/javascript" language="javascript" src="js/bootstrap/bootstrap-datetimepicker.min.js"></script>
...
<body>
<!-- <div id="spinner_system" class="spinner"><img id="img-spinner" src="images/loader.gif" alt="Загрузка" /></div> -->
