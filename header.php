...
if (isset ( $_SESSION ['OraLogin'] )) 
{
	...
	$curURLname = "Задачи операторам";	

	if($curURL=="month_report.php")
	$curURLname = "Долги к зарплате";	
...
<title><?php echo 'Новый сайт :: ' . $curURLname;?></title>
...
<div class="form-wrap">
    <div class="title">
        Карта
        <section class="close close_WRAP">закрыть</section>
    </div>
